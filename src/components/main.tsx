    ...
    <div className="flex flex-col min-h-[100dvh]">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex gap-x-4 items-center justify-center" href="https://twitter.com/ChukwumaNwaugha" target="_blank">
          <Image className="object-contain object-center rounded-md"  width="50" height="50" src="https://nwaughachukwuma.github.io/portfolio/images/dev_avatar.png" alt="Chukwuma Nwaugha Avatar" />
